...
export function validatePortfolioInput(payload) {
  const errors = {};
...
export function validateAboutInput(payload) {
  ...
  return { errors, sanitized: { headline, introParagraph, artisticVision, experienceCredentials, ctaText, ctaLink } };
}
...
export function validateServiceInput(payload) {
  ...
  return { errors, sanitized: { title, description, details, pricing } };
}
...
export function validateContactSubmissionInput(payload) {
  ...
  return { errors, sanitized: { name, email, phone, message } };
}
